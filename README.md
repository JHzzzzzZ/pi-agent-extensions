...
- **测试** — 仓库根 `npm run test:todo`（101 个，含进程边界 E2E + 根发现 / skill 结构 / 依赖图纯函数 / reopen 回退与归档 / 并发/中断真子进程 + 迁移 roundtrip）；卡片见 [`docs/tools/todo-cli.md`](docs/tools/todo-cli.md)
...
npm run test:todo                 # todo CLI（101 个）
