...
D
- **数量（grep 实测）：** pwr 438 个测试，分布在 35 个 `*.test.ts`（test/ 104、tests/ 233、runtime/test/ 56、runner/test/ 45）；stream-token-speed 45；agent-team 322；run-timer 59；loop 193；goal 62；provider-quota 26；opencode-bridge 114；chatanywhere-provider 32；deep-init 37；human-notify 37；solo-mode 14；根契约 3。
