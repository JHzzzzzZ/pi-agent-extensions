...
cd agent-team && npm install && npm test                                        # 93 tests (node --test test/*.test.ts)
...
- **Counts (measured via grep):** pwr 405 tests across 33 `*.test.ts` files (test/ 100, tests/ 204, runtime/test/ 56, runner/test/ 45); stream-token-speed 43; agent-team 93; run-timer 47; loop 169; goal 39; provider-quota 15.
