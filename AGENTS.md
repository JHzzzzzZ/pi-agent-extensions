...
- **Counts (measured via grep):** pwr 380 tests across 32 `*.test.ts` files (test/ 100, tests/ 189, runtime/test/ 54, runner/test/ 37) — READMEs claim 346, DELIVERY.md 322; trust the measured count. stream-token-speed 43; agent-team 85; run-timer 47; loop 169; goal 39; provider-quota 15.
