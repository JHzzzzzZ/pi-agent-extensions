...
- [x] 命令面全量改为冒号命名空间式（完成 2026-09-14 @ feat/commands-colon：6 插件全量冒号化——agent-team v1.12.0 / pwr v2.8.0 / opencode-bridge v1.7.0 / loop v1.6.0 / goal v1.3.0 / solo-mode v1.2.0；48 条命令经真实 pi loader 冒烟全部注册且有描述；旧空格写法只提示改名、绝不执行；详见各插件条目的完成记录）
