...
| todo 统一全局 id（globalId 主键与双轨 / 计数器与写门禁 / 存量迁移与回滚） | `tools/todo-cli.md` + `adr/0008-todo-global-id.md` + `specs/todo-cli-global-id.md` |
...
| 状态条刷新节拍 / footer 排序带 / 段分隔与首段定格 / widget 排序带契约 | `cross/status-bar.md` |
